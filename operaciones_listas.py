...
lista1 = [6, 3, 9, 1, 4]
sum_lista = sum(lista1)
print("El resultado de la suma de todos los números en la lista es ", sum_lista)

# 2. Escribir una función mayor_elemento(lista) que reciba una lista de números y devuelva el mayor elemento.
lista2= [2, 4, 8, 6]
mayor_elemento = max(lista2)

print("El mayor elemento de la lista es ", mayor_elemento)
